...
var net = createSprite(200, 28,200,20)
net.setAnimation("apple_1")
...
stroke("SKYBLUE")
  strokeWeight(10)
  fill("blue")
  text("Goals:"+goal,310,350);
  textFont("ALGERIAN")
  textSize(18)
  fill("GREEN")
  text("a Apple a day keeps doctor away",65,380);
  textSize(18)
  fill("YELLOW")
  stroke("ORANGE")
  strokeWeight(10)
